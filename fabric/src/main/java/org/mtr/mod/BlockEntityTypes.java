...
public final class BlockEntityTypes {
	...
	static {
		...
		DATA_TERMINAL = Init.REGISTRY.registerBlockEntityType(new Identifier(Init.MOD_ID, "data_terminal"), BlockDataTerminal.BlockEntity::new, Blocks.DATA_TERMINAL::get);
	...
	public static final BlockEntityTypeRegistryObject<BlockDataTerminal.BlockEntity> DATA_TERMINAL;
